...
export default function page() {
  return (
    <>
      <div className="h-screen w-full bg-[url('/youssef.png')] bg-center bg-cover bg-fixed">
        <div className="h-screen w-full bg-black/50 flex flex-col items-center justify-center">
          ...
          <Typewriter className="text-yellow-500"/>
            <div className="text-white font-bold">
                <a href="https://www.facebook.com/youssef.hashish.5" className="m-5 icon fab fa-facebook hover:text-yellow-500" target="_blank" rel="noopener noreferrer" title="Facebook"></a>
                <a href="https://www.instagram.com/youssef.hashish/" className="m-5 icon fab fa-instagram hover:text-yellow-500" target="_blank" rel="noopener noreferrer" title="Instagram"></a>
