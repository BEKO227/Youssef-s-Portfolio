        ...
        <div className="h-screen w-full bg-black/50 flex flex-col items-center justify-center">
          ...
          <Typewriter className="text-yellow-500"/>
            <div className="text-white font-bold">
                ...
                <a href="https://www.instagram.com/yousfhashish?igsh=eG11NGRkZmQwaHV5&utm_source=qr" className="m-5 icon fab fa-instagram hover:text-yellow-500" target="_blank" rel="noopener noreferrer" title="Instagram"></a>
